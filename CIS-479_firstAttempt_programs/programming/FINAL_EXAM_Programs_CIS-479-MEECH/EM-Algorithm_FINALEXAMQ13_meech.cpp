...
static const int n_numData = 5;
static const int k_clusters = 2;
int update_iteration = 0;
vector<float> data_set{ 0.7, 0.9, 1.6, 2.5, 3.4 };
...
int main()
{
	...
	weight[0] = 0.2, mean[0] = 0.7, stand_dev[0] = sqrt(1); //soft cluster k1
	weight[1] = 0.8, mean[1] = 0.9, stand_dev[1] = sqrt(1); //soft cluster k2
