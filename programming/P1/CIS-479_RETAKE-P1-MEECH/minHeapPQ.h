...
//#include "minHeapPQ.cpp" //<---- OPTION 1 SOLUTION (see below) 
#endif 
...
//then just #include the .h file in the main program source file.
//2)just #include the .h and the cpp files of the header in the main program source file.
//**for this situation, I tested both cases (they both work!), and decided to go with option 2 for this test project.